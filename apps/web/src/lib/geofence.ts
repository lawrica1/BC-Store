...
// Falls back to the real BC Store pin (Plus Code 3P58+JV6 Douala) if VITE_STORE_LATITUDE/LONGITUDE aren't set in .env.
const envLat = Number(import.meta.env.VITE_STORE_LATITUDE);
const envLng = Number(import.meta.env.VITE_STORE_LONGITUDE);
